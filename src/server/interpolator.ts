/**
 * Created by nazarigonzalez on 26/7/16.
 */
export function interpolate(from:number, to:number, totalTime:number, elapsedTime:number, easing:(t:number)=>number = Easing.linear()):number{
